...
export function AuthorsPage() {
  ...
  // Identity lookups come from the ONE hook the Author Map also uses, over the
  // same React Query caches — so this page and the map can never disagree
  // about who is followed or who is being suggested.
  const { authors, followedIds, ownerId } = useAuthorIdentity()
