...
>(({ className, align = "center", sideOffset = 4, ...props }, ref) => (
  <PopoverPrimitive.Portal>
    {/* Floating menu at level 3 — clearly lighter than the page card it
     * sprang from; provider set inside the portal so descendants climb. */}
